	...
	<tr>
		...
		<td>
			<div class="input-append">
				<input class="number required  no-margin" name="tax" id="appendedInput" size="16" type="text" value="<?=$settings->tax;?>"><span class="add-on">%</span>
			</div>
		</td>
	</tr>
	<tr>
		<td><?=$this->lang->line('application_default_currency');?></td>
		<td><input type="text" name="currency" class="required no-margin" value="<?=$settings->currency;?>"></td>
	</tr>
	<tr>
		...
		<td> <?php $options = array();
			...
			echo form_dropdown('template', $options, $settings->template); ?>
		</td>
	</tr>
	<tr>
		...
		<td> <?php $options = array();
			...
			echo form_dropdown('language', $options, $settings->language); ?>
		</td>
	</tr>
	<tr>
		...
		<td> <?php $options = array(
			...
			echo form_dropdown('date_format', $options, $settings->date_format); ?>
		</td>
	</tr>
	<tr>
		...
		<td> <?php $options = array(
			...
			echo form_dropdown('date_time_format', $options, $settings->date_time_format); ?>
		</td>
	</tr>
		<tr>
