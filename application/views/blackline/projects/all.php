<div id="main">
		...
		<tr id="<?=$value->id;?>" >
			...
			<td  class="hidden-phone"><span class="label <?php if($value->end <= date('Y-m-d') && $value->progress != 100){ echo 'label-important tt" title="'.$this->lang->line('application_overdue'); } ?>"><?php $unix = human_to_unix($value->end.' 00:00'); echo date($core_settings->date_format, $unix);?></span></td>
