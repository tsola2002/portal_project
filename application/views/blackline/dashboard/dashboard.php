...
<?php } ?>
    ...
    <hr>
      ...
      <div id="stat-numbers" class="offset-top">
        ...
        <div class="span3"><h2><?=$core_settings->currency;?> <?php if(empty($payments[0]->summary)){echo "0";}else{echo number_format($payments[0]->summary); }?></h2> <h5><?=$month?> <?=$this->lang->line('application_payments');?></h5></div>
