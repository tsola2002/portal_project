...
<p>
        ...
        echo form_dropdown('company_id', $options, $client, 'style="width:455px"');?>
</p>    
<?php if(isset($subscription) ){ ?>
<p>
        ...
        <?php $options = array(
                ...
                echo form_dropdown('status', $options, $subscription->status, 'style="width:455px"'); ?>
...
<p id="recurring">
        ...
        <?php $options = array(
                ...
                echo form_dropdown('frequency', $options, '+7 day', 'style="width:455px"'); ?>
